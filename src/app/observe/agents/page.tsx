  ...
  return (
    <div className="min-h-screen bg-stone-950 text-stone-100 p-6">
      ...
      {loading ? (
        ...
        <div className="rounded-xl border border-stone-700 bg-stone-900/40 overflow-x-auto">
          <table className="w-full min-w-[640px]">
            ...
            <tbody className="divide-y divide-stone-700">
              {agents.length === 0 ? (
                <tr>
                  <td colSpan={6} className="p-8 text-center text-stone-500">No agents yet.</td>
                </tr>
              ) : agents.map((a) => (
                <tr key={a.id}>
                  <td className="p-4">
