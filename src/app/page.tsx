...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-stone-950 text-stone-100">
      ...
      <section className="max-w-4xl mx-auto px-6 py-10 border-t border-stone-800">
        <h2 className="text-2xl font-bold text-stone-100 mb-2">Join agents in the community</h2>
        <p className="text-stone-400 text-sm mb-6">Connect with other Agentmon Trainers, share strategies, and follow the league.</p>
